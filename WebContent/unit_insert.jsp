					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 col-md-12 col-sm-12">
								<!-- PAGE CONTENT BEGINS -->
					        <form class="form-horizontal" role="form" name="intake_insert" method="post" action="UnitInsertController">
									   <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Unit Name:</label> 
                                        <div class="col-sm-6" >
                                            <input placeholder="Enter Unit Name" required class="form-control" type="text"  name="unit_name" id="category" required>
                                        </div>
										</div>
