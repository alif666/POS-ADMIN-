						...
						<div class="page-header">
							<div class="row">
							   <div class="col-xs-12 col-md-4 col-sm-4">
										<h1>
												<a href="IngredientsInsertController" class="btn btn-success">Add New Ingredient</a>
										</h1>
								</div>
											...
											<table id="dynamic-table" class="table  table-striped table-bordered table-hover table-responsive">
												 <thead>
													<tr >
													  ...
													  <th><strong>LiveStock</strong></th>
													  <th><strong>Wastage</strong></th>
													  <th><strong>Per Day Consumption</strong></th>
													  <th><strong>Minimum Stock</strong></th>
													  <th><strong>equivalentRatio</strong></th>
													  <th><strong>Equivalent Quantity</strong></th>
													  <th><strong>Equi Unit</strong></th>
											 ...
											 <tbody>
												<c:forEach var="ingredients" items="${ingredients}">
													<tr>
											             <td><c:out value="${ingredients.id}"/></td>
											             <td><c:out value="${ingredients.name}"/></td>
											             <td><c:out value="${ingredients.livestock}"/></td>
											             <td><c:out value="${ingredients.wastage}"/></td>
											             <td><c:out value="${ingredients.perDayConsumption}"/></td>
											             <td><c:out value="${ingredients.minimumStock}"/></td>
											             <td><c:out value="${ingredients.equivalentRatio}"/></td>
											             <td><c:out value="${ingredients.equivalentQuantity}"/></td>
											             <td><c:out value="${ingredients.equivalentUnit.unitName}"/></td>
											             <td><c:out value="${ingredients.unitId.unitName}"/></td>
													  <td>
													   		<div class="action-buttons">
															 <div class="col-sm-12">
																
																<a class="green" href="IngredientsEditController?id=${ingredients.id}" >
																	<i class="ace-icon fa fa-pencil-square-o bigger-130"></i>
																</a>
															    <a class="red" href="IngredientsDeleteController?id=${ingredients.id}" >
