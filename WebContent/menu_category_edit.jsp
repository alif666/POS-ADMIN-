					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 col-md-12 col-sm-12">
								<!-- PAGE CONTENT BEGINS -->
										<form id="unitForm" method="Post"  action="MenuCategoryEditController" class="form-horizontal bv-form">
												
												<div class="form-group row ">
													<label class="col-lg-3 control-label">Category Id</label>
													<div class="col-lg-6">
														<input type="text" class="form-control" placeholder= <c:out value="${category.id}"/> name="category_id" value = "${category.id}">
													</div>
												</div>
												...
												<div class="form-group row ">
													...
													<div class="col-lg-6">
														<input type="text" class="form-control" value= <c:out value="${category.menuCategoryName}"/> name="category_name" required>
													</div>
												</div>
												...
												<div class="form-group row ">
													...
													<div class="col-lg-6">
														<input type="text" class="form-control" value= <c:out value="${category.menuCategoryColor}"/> name="category_color" required>
													</div>
												</div>
