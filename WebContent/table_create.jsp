					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 col-md-12 col-sm-12">
								<!-- PAGE CONTENT BEGINS -->
									<form id="tableForm" method="Post"  action="TableInsertController" class="form-horizontal bv-form">
															
															<div class="form-group row ">
																<label class="col-lg-3 control-label">Table Number</label>
																<div class="col-lg-6">
																	<input type="number" class="form-control" placeholder="Enter how many tables" name="table_number" data-bv-field="uname" required>
																</div>
															</div>
									...
									<form id="tableForm" method="Post"  action="TableDeleteController" class="form-horizontal bv-form">	
										<div class="form-group row gutter">
											<div class="col-lg-6 col-lg-offset-6">
												<button type="submit" class="btn btn-success" >
													<span class="circless animate" style="height: 70px; width: 70px; top: -19px; left: 26.25px;"></span>Delete All
												</button>
											</div>
										</div>
									</form>
