									...
									<div class="col-xs-12">
										<div class="tab-content col-sm-11"  style="padding:0px 0px 0px 8px; border:none;">
											...
											<div id="all" class="tab-pane active">
									            ...
									            <c:forEach var="yearlyDetails" items="${yearlyDetails}" varStatus="counter">
													 <tr>
														<td align="center">${counter.count}</td>
														<td><c:out value="${months[yearlyDetails[3]-1]}"/></td>
														<td><c:out value="${yearlyDetails[1]}"/></td>
														<td><c:out value="${yearlyDetails[0]}"/></td>
														<td><c:out value="${yearlyDetails[2]}"/></td>
													 </tr>
								                 </c:forEach>  						      
                                                </tbody>
											  </table>
