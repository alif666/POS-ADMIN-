					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 col-md-12 col-sm-12">
								<!-- PAGE CONTENT BEGINS -->
					        <form class="form-horizontal" role="form" name="intake_insert" method="post" action="UnitEditController">
									   <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Unit Name:</label> 
	                                        <div class="col-sm-6" >
	                                        	<input type="hidden" class="form-control" value= <c:out value="${unit.id}"/> name="unit_id" value = "${unit.id}">
	                                            <input type="text" class="form-control" value= <c:out value="${unit.unitName}"/> name="unit_name" data-bv-field="uname" required>
	                                        </div>
										</div>
