				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Menu Category List</li>
						</ul><!-- /.breadcrumb -->
						...
						<div class="page-header">
							<div class="row">
							   <div class="col-xs-12 col-md-4 col-sm-4">
										<h1>
												<a href="MenuCategoryInsertController" class="btn btn-success">Add New Menu Category</a>
										</h1>
								</div>
											 ...
											 <tbody>
												<c:forEach var="category" items="${category}">
													<tr>
													  ...
													  <td ><c:out value="${category.menuCategoryName}"/></td>
													  <td >
