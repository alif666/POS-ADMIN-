						...
						<div class="page-header">
							<div class="row">
							   <div class="col-xs-12 col-md-4 col-sm-4">
										<h1>
												<a href="unit_insert.jsp" class="btn btn-success">Add New Unit</a>
										</h1>
								</div>
											...
											<table id="dynamic-table" class="table  table-striped table-bordered table-hover table-responsive">
											 ...
											 <tbody>
												<c:forEach var="unit" items="${units}">
													<tr>
													  <td  align="center"><c:out value="${unit.id}"/></td>
													  <td ><c:out value="${unit.unitName}"/></td>
													  <td >
													   		<div class="action-buttons">
															 <div class="col-sm-12">
																
																<a class="green" href="UnitEditController?id=${unit.id}" >
																	<i class="ace-icon fa fa-pencil-square-o bigger-130"></i>
																</a>
															    <a class="red" href="UnitDeleteController?id=${unit.id}" >
