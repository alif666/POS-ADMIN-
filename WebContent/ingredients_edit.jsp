					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12 col-md-12 col-sm-12">
								<!-- PAGE CONTENT BEGINS -->
					        <form class="form-horizontal" role="form" name="intake_insert" method="post" action="IngredientsEditController">
									   <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Ingredients Name:</label> 
	                                        <div class="col-sm-6" >
	                                          <input type="hidden" class="form-control"  name="ingredients_id" value = "${ingredients.id}">
	                                            <input value="<c:out value="${ingredients.name}"/>" required class="form-control" type="text"  name="ingredients_name" required>
	                                        </div>
										</div>
											...
											<div id = "leadTime" class="form-group row ">
												...
												<div class="col-lg-6">
													<input type="text" class="form-control" value = "<c:out value="${ingredients.perDayConsumption}"/>" name="per_day_consumption">
												</div>
											</div>
												...
												<div class="form-group row ">
													...
													<div class="col-lg-6">
														<input type="text" class="form-control" value="<c:out value="${ingredients.equivalentRatio}"/>" name="equ_ratio">
													</div>
												</div>
												...
												<div class="form-group row ">
													...
													<div class="col-lg-6">
														<input type="text" class="form-control" value= "<c:out value="${ingredients.minimumStock}"/>" name="min_qty">
													</div>
												</div>
												...
												<div class="form-group row ">
													...
													<div class="col-lg-6">
														<input type="text" class="form-control" value= "<c:out value="${ingredients.livestock}"/>" name="livestock">
													</div>
												</div>
