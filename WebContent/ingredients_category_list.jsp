				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Ingredients Category List</li>
						</ul><!-- /.breadcrumb -->
						...
						<div class="page-header">
							<div class="row">
							   <div class="col-xs-12 col-md-4 col-sm-4">
										<h1>
												<a href="IngredientsCategoryInsertController" class="btn btn-success">Add New Ingredients Category</a>
										</h1>
								</div>
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											Results for "Ingredients Category"
										</div>
											...
											<table id="dynamic-table" class="table  table-striped table-bordered table-hover table-responsive">
											 ...
											 <tbody>
												<c:forEach var="category" items="${category}">
													<tr>
													  <td  align="center"><c:out value="${category.id}"/></td>
													  <td ><c:out value="${category.ingredientsCategoryName}"/></td>
													  <td >
													   		<div class="action-buttons">
															 <div class="col-sm-12">
																
																<a class="green" href="IngredientsCategoryEditController?id=${category.id}" >
																	<i class="ace-icon fa fa-pencil-square-o bigger-130"></i>
																</a>
															    <a class="red" href="IngredientsCategoryDeleteController?id=${category.id}">
